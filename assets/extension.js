...
function activate(context) {
    ...
    [
        ...
        { cmd: 'tmpleggservice', languageId: 'vmate.eggjs.service' },
        { cmd: 'tmpleggcontroller', languageId: 'vmate.eggjs.controller' },
        { cmd: 'tmpldvaservice', languageId: 'vmate.dva.service' },
        { cmd: 'tmpldvamodel', languageId: 'vmate.dva.model' },
        { cmd: 'tmplvmateentity', languageId: 'vmate.eggjs.entity' },
        { cmd: 'tmpldvaview', languageId: 'vmate.dva.view' },
    ].forEach(e => {
